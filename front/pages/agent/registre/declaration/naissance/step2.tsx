export default function Step2({change}){
    return<>
        ...
        <form >
            ...
            <input type="date" placeholder="Date de naissance" name="dateNaissancePere" onChange={change} id="" />
            <input type="text" placeholder="Lieu de naissance" name="lieuNaissancePere" onChange={change} id="" />
